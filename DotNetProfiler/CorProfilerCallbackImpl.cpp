...
// ICorProfiler6
HRESULT STDMETHODCALLTYPE CCorProfilerCallbackImpl::GetAssemblyReferences(const WCHAR *wszAssemblyPath, ICorProfilerAssemblyReferenceProvider *pAsmRefProvider)
{
	return S_OK;
}

//ICorProfiler7
HRESULT STDMETHODCALLTYPE CCorProfilerCallbackImpl::ModuleInMemorySymbolsUpdated(ModuleID moduleId) 
{
	return S_OK;
}

// ICorProfiler8
HRESULT STDMETHODCALLTYPE CCorProfilerCallbackImpl::DynamicMethodJITCompilationStarted(FunctionID functionId, BOOL fIsSafeToBlock, LPCBYTE pILHeader, ULONG cbILHeader)
{
	return S_OK;
}

HRESULT STDMETHODCALLTYPE CCorProfilerCallbackImpl::DynamicMethodJITCompilationFinished(FunctionID functionId, HRESULT hrStatus, BOOL fIsSafeToBlock)
{
	return S_OK;
}